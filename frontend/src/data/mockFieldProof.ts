...
export const workEntries: WorkEntry[] = [
  ...
  },
  {
    ...
    customerName: "Mesa Property Group",
    customerPhone: null,
    customerEmail: null,
    customerContactName: "Elena Martinez",
    workType: "Inspection",
    workDate: "2026-07-19",
    status: "SUBMITTED",
...
export const mockReport: ReportSnapshot = {
  ...
  customerName: workEntries[0].customerName,
  customerPhone: workEntries[0].customerPhone,
  customerEmail: workEntries[0].customerEmail,
  customerContactName: workEntries[0].customerContactName,
